            ...
            <div className='container'>
                <div className="card mb-3" style={estiloDiv}>
                    <div className="col-md-12">
                        <div className="card-body">
                            <h2 className="card-title">
                                {store?.services[2]?.individuals[params.index]?.name}
                            </h2>
                        </div>
                    </div>
                    <div className="row g-0">
                        <div className="col-md-12" style={estiloDiv3}>
                            <iframe
                                width="90%"
                                height="450"
                                src={store?.services[2]?.individuals[params.index]?.urlmedia}
                                frameBorder="0"
                    ...
                    <div className="col-md-12" style={estiloDiv4}>
                        <div className="card-body">
                            <p className="card-text" style={estiloText}>
                                {store?.services[2]?.individuals[params.index]?.description}
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="container-category">
                                <div className="col-12">
                                    ...
                                    <div style={estiloText2}>
                                        {store?.services[2]?.individuals[params.index]?.especification}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="header-container mb-4 d-flex" style={estiloDiv}>
                        <Link to="/spirituality" className="btn btn-primary" style={estiloLink}>Volver</Link>
                    </div>
                </div>
            </div>
        </>
