                    ...
                    <div className="col-md-12">
                        <div className="card-body">
                            <h2 className="card-title">
                                {store?.services[6]?.individuals[params.index]?.name}
                            </h2>
                        </div>
                    </div>
                    <div className="row g-0">
                        <div className="col-md-12" style={estiloDiv3}>
                            <iframe
                                width="90%"
                                height="450"
                                src={store?.services[6]?.individuals[params.index]?.urlmedia}
                                frameBorder="0"
                    ...
                    <div className="col-md-12" style={estiloDiv4}>
                        <div className="card-body">
                            <p className="card-text" style={estiloText}>
                                {store?.services[6]?.individuals[params.index]?.description}
                            </p>
                        </div>
                    </div>
...
export default DetailsSustainability;